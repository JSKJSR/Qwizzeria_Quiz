...
- **Dashboard**: High-level stats, quick-play actions, resumable sessions, league badge and weekly XP, and daily mission progress.
  ...
  - **League Badge**: Shows the user's current league (e.g., Bronze, Silver, Gold, Platinum) and weekly XP earned within that league.
...
- **Real-Time Buzzer System**: Hosts can activate a live buzzer overlay. Participants join via the `/buzz` route using a generated room code. The system features sub-millisecond precision, sound effects, and a dynamic host overlay to determine who buzzed first.
...
- **AI Quiz Generation**: Professional hosts can generate custom quiz packs on any topic instantly.
    ...
    - **Customization**: Supports question count and difficulty levels (accessible to Admins). Rate limited to 5/hour and 20/day for Pro users; unlimited for staff.
- **Tournaments**:
...
- **Pro Tier**: $19.99/mo. Unlocks local/party Game Hosting, Doubles Quiz, AI Quiz Generation (Claude 3.5), Real-Time Buzzer, Tournament brackets, Export Results, Certificates, and 30 Streak Freezes per month.
